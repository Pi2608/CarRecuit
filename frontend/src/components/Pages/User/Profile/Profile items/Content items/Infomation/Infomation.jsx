        ...
        <div id="info">
            <div className="container user-profile">
                                ...
                                {close => (
                                    <div className="modal">
                                        ...
                                        <form type="submit" 
                                            ...
                                            onSubmit={(e) => {handleInfo(e); close()}}
                                            >
                                            <label>
                                                <p style={{fontWeight: "500", lineHeight: "2", color: "#767676"}}>Tên tài khoản</p>
                                                <TextField
                                            ...
                                            <label>
                                                <p style={{fontWeight: "500", lineHeight: "2", color: "#767676"}}>Số điện thoại</p>
                                                <TextField
                                                    type="number"
                                                    ...
                                                    helperText={(!checkValidation || !checkNumChar) ? (!userPhoneNumber ? 'Xin hãy nhập số điện thoại' : 'Số điện thoại không hợp lệ') : ('')}
                                                ></TextField>
                                            </label>
                                            <label>
                                                <p style={{fontWeight: "500", lineHeight: "2", color: "#767676"}}>Ngày sinh</p>
                ...
                <div className="content">
                    <div className="avatar-box">
                        ...
                        <div className="ctn">
                            <p className="user-name">{userInfo.name ? userInfo.name : "User"}</p>
                    ...
                    <div className="info-user">
                        <div className="info-box">
                            <div className="info-box-item">
                                <p>Ngày sinh</p>
                                <p className="main">{userInfo.dateOfBirth ? handleDate(userInfo.dateOfBirth) : "--/--/----"}</p>
                            </div>
                            <div className="info-box-item">
                                <p>Giới tính</p>
                        ...
                        <div className="info-desc">
                            ...
                            <div className="info-desc-item">
                                ...
                                <p className="main">{userInfo.wallet ? userInfo.wallet : "0"} K</p>
                            </div> 
                        </div>
                        <div className="topup">
                            <div className="topup-btn" onClick={() => navigate("/user/transaction")}>Nạp</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="title">
                    <div>
                        ...
                        {userNIDInfo ? (
                            ...
                            <div style={{ backgroundColor: "#00FF00", borderRadius: "8px", padding: "3px", paddingRight: "6px"}}>
                                <CheckCircleOutlinedIcon style={{ height: "10px", width: "12px", color: "green" }} />
                                <p>Đã xác thực</p>
                            </div>
                            :
                            <div style={{ backgroundColor: "#FF6A6A", borderRadius: "8px", padding: "3px", paddingRight: "6px"}}>
                    ...
                    {disableCCCD ? 
                        <div className="edit-btn" onClick={handleCCCD}>Chỉnh sửa</div>                     
                    :
                    <div className="btn-container">
                       <div onClick={handleCCCD} style={{cursor: "pointer"}}>Hủy</div>
                       <div className="edit-btn" onClick={handleCCCD}>Lưu</div>
                    </div>
                    }
                </div>
                <div className="content">
            ...
            <div className="container">
                <div className="title">
                    ...
                    {disableGPLX ? 
                        <div className="edit-btn" onClick={handleGPLX}>Chỉnh sửa</div>                     
                    :
                    <div className="btn-container">
                       <div onClick={handleGPLX} style={{cursor: "pointer"}}>Hủy</div>
                       <div className="edit-btn" onClick={handleGPLX}>Lưu</div>
                    </div>
                    }
                </div>
                <div className="content">
